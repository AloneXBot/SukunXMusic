...
import config
from SukunXMusic import Carbon, YouTube, app
...
from SukunXMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from SukunXMusic.utils.inline.playlist import close_markup
from SukunXMusic.utils.pastebin import Sukunbin
from SukunXMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Sukun.force_stop_stream(chat_id)
