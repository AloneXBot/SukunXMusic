...
from SukunXMusic.utils.database import (get_cmode, get_lang,
                                       get_playmode, get_playtype,
                                       is_active_chat,
                                       is_commanddelete_on,
                                       is_served_private_chat)
from SukunXMusic.utils.database.memorydatabase import is_maintenance
        ...
        if await is_maintenance() is False:
            if message.from_user.id not in SUDOERS:
                return await message.reply_text(
                    "ᴍᴀɪɴ ᴍᴀɪɴᴛᴇɴᴄᴇ ᴘᴇ ᴊᴀᴀ ʟᴀʜɪ ᴛʜᴏʟɪ ᴅᴇʟ ᴍᴇ ᴀᴄᴛɪᴠᴇ ᴀᴀᴜɴɢI ᴏᴛᴇʏ ᴡᴀɪᴛ ᴋᴀʟɴᴀ ᴊᴀᴀᴀɴ ᴍᴜᴜᴜᴜᴜᴀᴀᴀᴀᴀᴀᴀʜ ..."
                )
