...
from SukunXMusic.core.userbot import assistants
from SukunXMusic.misc import SUDOERS, pymongodb
from SukunXMusic.plugins import ALL_MODULES
from SukunXMusic.utils.database import (get_global_tops,
                                       get_particulars, get_queries,
                                       get_served_chats,
                                       get_served_users, get_sudoers,
                                       get_top_chats, get_topp_users)
from SukunXMusic.utils.decorators.language import language, languageCB
from SukunXMusic.utils.inline.stats import (back_stats_buttons,
                                           back_stats_markup,
                                           get_stats_markup,
...
async def gstats_global(client, message: Message, _):
    ...
    title = title.title()
    final = f"sᴀʙsᴇ ᴊʏᴅᴀ ᴘʟᴀʏ ʜᴜᴀ ɴᴀ ➳⃝😻 {MUSIC_BOT_NAME} 『 🇮🇳 』ᴍᴇ\n\n**𖢵 ᴛɪᴛʟᴇ:** {title}\n\n𖢵 ᴩʟᴀʏᴇᴅ ** {co} **ᴛɪᴍᴇs.\n\n╭⎋ {MUSIC_BOT_NAME} 🫧\n╰⊚ sᴛᴀᴛᴜs: ᴏɴʟɪɴᴇ ✨\n\n๏ ᴘᴏᴡᴇʀᴇᴅ ʙʏ:\n ➻❥ @TeamSukun\n ➻❥ @sukunupdates\n ➻❥ @sukunsupports"
