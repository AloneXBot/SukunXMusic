...
from SukunXMusic.utils.database import get_lang, set_lang
from SukunXMusic.utils.decorators import (ActualAdminCB, language,
                                         languageCB)
...
async def language_markup(client, CallbackQuery, _):
    ...
    if str(old) == str(langauge):
        return await CallbackQuery.answer(
            "ᴀʟʀᴇᴀᴅʏ sᴀᴍᴇ ʟᴀɴɢᴜᴀɢᴇ ᴘᴇ ʜᴏ ʙᴀʙʏ @TeamSukun", show_alert=True
        )
    try:
        _ = get_string(langauge)
        await CallbackQuery.answer(
            "ʟᴀɴɢᴜᴀɢᴇ ᴄʜᴀɴɢᴇ ʜᴏ ɢʏᴀ ʙᴀʙʏ.", show_alert=True
        )
    except:
        return await CallbackQuery.answer(
            "ʟᴀɴɢᴜᴀɢᴇ ᴄʜᴀɴɢᴇ ɴᴏɪ ᴋᴀʟ ᴘᴀᴀ ʟᴀʜɪ ʙᴀʙʏ.",
            show_alert=True,
        )
