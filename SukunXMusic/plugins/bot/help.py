...
from SukunXMusic.utils import help_pannel
from SukunXMusic.utils.database import get_lang, is_commanddelete_on
from SukunXMusic.utils.decorators.language import (LanguageStart,
                                                  languageCB)
from SukunXMusic.utils.inline.help import (help_back_markup,
                                          private_help_panel)
    ...
    if cb == "hb5":
        if CallbackQuery.from_user.id not in SUDOERS:
            return await CallbackQuery.answer(
                "ᴊᴀʜᴀ ᴛᴀᴋ ɪᴢᴢᴀᴛ ʜᴏ ᴡᴀʜɪ ᴛᴀᴋ ᴜɴɢʟɪ ᴅᴀʙᴀᴛᴇ ʜ ɴᴀ ʙᴀʙʏ @TeamSukun", show_alert=True
            )
        else:
