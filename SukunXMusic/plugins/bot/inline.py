...
from SukunXMusic.utils.inlinequery import answer
...
𖢵 **ᴅᴜʀᴀᴛɪᴏɴ:** {duration} Mins
𖢵 **ᴠɪᴇᴡs:** `{views}`
𖢵 **ᴘᴜʙʟɪsʜᴇᴅ ᴛɪᴍᴇ:** {published}
𖢵 **ᴄʜᴀɴɴᴇʟ ɴᴀᴍᴇ:** {channel}
𖢵 **ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ:** [Visit From Here]({channellink})
