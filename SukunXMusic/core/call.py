...
from SukunXMusic import LOGGER, YouTube, app
from SukunXMusic.misc import db
from SukunXMusic.utils.database import (add_active_chat,
                                       ...
                                       set_loop)
from SukunXMusic.utils.exceptions import AssistantErr
from SukunXMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
...
class Call(PyTgCalls):
    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**ɴᴏ ᴀᴄᴛɪᴠᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ғᴏᴜɴᴅ**\n\nᴏʟᴇ ʙᴀʙʏ ᴘʜᴇʟᴇ ᴅᴇᴋʜᴏ ᴠᴄ ᴏɴ ʜ ɴᴀ ʙᴀᴄʜᴀ . ᴀɢᴀʟ ᴏɴ ʜ ᴛᴏʜ ᴇᴋ ʙᴀᴀʟ ɴᴀ ʙᴀɴᴅ ᴋᴀʟᴋᴇ ᴘʜɪʟ ᴄʜᴇ ᴄʜᴜʟᴜ ᴋᴀʟʟᴏ ᴏᴛᴇʏ ʙᴀʙʏ , ʏᴀʜɪ ᴘʜɪʀ ᴄᴏᴍᴍᴀɴᴅ ᴅᴀʟʟᴏ /restart"
                )
        except AlreadyJoinedError:
            raise AssistantErr(
                "**ᴀssɪsᴛᴀɴᴛ ᴀʟʀᴇᴀᴅʏ ɪɴ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ**\n\nᴏʏᴇᴇᴇᴇᴇᴇ ʙᴀʙʏ ʏᴇʜ ᴋʏᴀ ʙᴀᴀᴛ ʜᴜɪ ᴅᴏ ᴅᴏ sᴏɴɢs ᴇᴋ sᴀᴀᴛʜ ᴅᴇᴅᴇ ᴍᴇʟᴇ ᴋᴏ ɢɴɴɪ ʙᴀᴀᴛ ʜ .\n\nᴀɢᴀʟ ᴏɴ ʜ ᴛᴏʜ ᴇᴋ ʙᴀᴀʟ ɴᴀ ʙᴀɴᴅ ᴋᴀʟᴋᴇ ᴘʜɪʟ ᴄʜᴇ ᴄʜᴜʟᴜ ᴋᴀʟʟᴏ ᴏᴛᴇʏ ʙᴀʙʏ , ʏᴀʜɪ ᴘʜɪʀ ᴄᴏᴍᴍᴀɴᴅ ᴅᴀʟʟᴏ /restart"
            )
    ...
    async def start(self):
        LOGGER(__name__).info("Starting SukunXMusic PyTgCalls Client\n")
        if config.STRING1:
